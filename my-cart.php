				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage1'];?>" alt="" width="200" height="150">
						</a>
					</td>
...
?>
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo "Rp ".($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']); ?>.00</span></td>
				</tr>
